...
export default function PageClient({ chat }: { chat: Chat }) {
  ...
  return (
    <div className="h-dvh bg-gray-900 text-gray-300">
    <div className="flex h-full">
      <div className="mx-auto flex w-full shrink-0 flex-col overflow-hidden lg:w-1/2">
        <div className="flex items-center gap-4 px-4 py-4 border-b border-gray-700">
          <Link href="/">
            <LogoSmall className="text-white" />
          </Link>
          <p className="italic text-gray-400">{chat.title}</p>
        </div>
