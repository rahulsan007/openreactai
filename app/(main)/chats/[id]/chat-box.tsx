...
<div className="mx-auto mb-5 flex w-full max-w-prose shrink-0 px-8">
  ...
  >
    <fieldset className="w-full" disabled={disabled}>
      <div className="relative flex rounded-lg border-4 border-gray-700 bg-gray-900">
        <div className="relative w-full">
          ...
          <textarea
            ...
            required
            name="prompt"
            className="peer absolute inset-0 w-full resize-none bg-transparent p-2 placeholder-gray-400 text-white focus:outline-none disabled:opacity-50"
            onKeyDown={(event) => {
