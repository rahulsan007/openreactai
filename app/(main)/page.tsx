...
export default function Home() {
  ...
  const handleScreenshotUpload = async (event:any) => {
    ...
    try {
      ...
      if (data.success) {
        setScreenshotUrl(data.fileUrl); // Update this to use fileUrl
      } else {
  ...
  return (
    <div className="relative flex grow flex-col bg-gray-900">
      ...
      <div className="isolate flex h-full grow flex-col">
        ...
        <div className="mt-10 flex grow flex-col items-center px-4 lg:mt-16">
          ...
          <h1 className="mt-4 text-balance text-center text-4xl leading-none text-gray-200 md:text-[64px] lg:mt-8">
          ...
          >
            <Fieldset>
              <div className="relative flex w-full max-w-2xl rounded-xl border-4 border-gray-600 bg-gray-900 pb-10">
                <div className="w-full">
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      name="prompt"
                      rows={1}
                      className="peer absolute inset-0 w-full resize-none bg-transparent p-3 placeholder-gray-500  text-white focus-visible:outline-none disabled:opacity-50"
                      value={prompt}
